        ...
        <Card sx={{ minWidth: 275 }}>
          <CardContent>
            {product
                  ...
                  <Grid container alignItems={'center'} justifyContent={'center'} >
                    <Grid item  >
                      <Box mt={2}>
                        ...
                        <Button component='a' onClick={handleDeleteProduct} color="warning" variant="outlined" align='center'>
                        {t('delete')}
                        </Button>
                      </Box>
                    </Grid>
              ...
              : <Typography variant='h4' color={'red'} align='center'>Product Not Found</Typography>}
